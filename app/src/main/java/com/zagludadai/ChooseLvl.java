...
import static com.zagludadai.Constants.DEPLINK;
import static com.zagludadai.Constants.MY_SUB_URL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (InternetCon.checkConnection(getApplicationContext())) {
            ...
            else
            {
                ...
                String url = "becomingbeluga";
                url = url + ".com/mT8sBCXT";
